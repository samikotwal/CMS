...
export default function ActivitiesPage() {
  ...
  const [activities, setActivities] = useState([
    ...
    { id: 2, name: "Sports Day", date: "2025-07-10", type: "Sports", description: "Inter-college sports competition" },
    { id: 3, name: "Cultural Fest", date: "2025-08-05", type: "Cultural", description: "Annual cultural festival" },
  ])
