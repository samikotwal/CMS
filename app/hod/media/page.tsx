...
export default function MediaPage() {
  ...
  const [media, setMedia] = useState([
    { id: 1, title: "Department Overview", type: "Video", filename: "dept_overview.mp4" },
    { id: 2, title: "Research Poster", type: "Image", filename: "research_poster.jpg" },
    { id: 3, title: "Course Syllabus", type: "Document", filename: "syllabus.pdf" },
  ])
    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="flex-1 ml-64 p-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl font-bold">Manage Department Media</CardTitle>
            </CardHeader>
            <CardContent>
