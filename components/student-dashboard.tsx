...
export function StudentDashboard() {
  ...
  const stats = [
    { title: "Courses Enrolled", value: 6, icon: Book, color: "bg-emerald-500" },
    { title: "Upcoming Exams", value: 3, icon: Clock, color: "bg-emerald-400" },
    { title: "Attendance Rate", value: 95, icon: Calendar, color: "bg-emerald-300" },
    { title: "Extracurricular Activities", value: 4, icon: Activity, color: "bg-emerald-200" },
  ]
  ...
  return (
    <div className="min-h-screen bg-green-50 flex">
      ...
      <div className="flex-1 ml-64">
        <header className="bg-emerald-100 shadow-sm border-b border-emerald-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
            <h1 className="text-2xl font-semibold text-emerald-800">Student Dashboard</h1>
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <Input
                  type="text"
                  placeholder="Search..."
                  className="pl-10 pr-4 bg-white border-emerald-200 placeholder-emerald-300 text-emerald-800 focus:border-emerald-400 focus:ring-emerald-400"
                />
              </div>
              <Button
                variant="ghost"
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <Tabs defaultValue="overview" className="mt-6">
            <TabsList className="bg-emerald-100 text-emerald-800">
              <TabsTrigger
                value="overview"
